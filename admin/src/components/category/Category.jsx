...
//                     </div>
//                     {/* work begins here */}
//                     <div className='subcatergoryTable'>
...
const Category = () => {
    ...
    const column = [
        ...
        { name: 'Category Name', selector: (row) => row.rolename, sortable: true },
        { name: 'Category Image', selector: (row) => row.rolename},
        { name: 'GST', selector: (row) => row.rolename}
    ];
